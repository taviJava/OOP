...
public class MasaBuilder {
    ...
    public MasaBuilder setPret(int pret) {
        this.pret = pret;
        return this;
    }
    ...
    public Masa build(){
        if (lungime==0){
            ...
            throw new RuntimeException("Trebuie sa setezi inaltimea");
        }if (material==null){
           throw new RuntimeException ("Trebuie sa setezi materialul");
        }if (culoare==null){
            throw new RuntimeException("Trebuie sa setezi culoarea");
        }if (pret==0){
            throw new RuntimeException("Trebuie sa setezi pretul");
        }
        Masa masa=new Masa();
        masa.setColturiRotunde(false).setLatime(100).setInaltime(100).setCuloare("Mahon").setLungime(200).setMaterial("Stejar").setSuprafataLucioasa(true).setPret(100);
        return masa;
    }
